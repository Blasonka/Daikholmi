...
<footer
    class="bd-footer bg-body-tertiary d-flex flex-wrap justify-content-between align-items-center px-5 py-4 py-md-5 mt-5 border-top">
    ...
    <a href="/"
        ...
        <img src="/img/diakholmilogo.svg" alt="">
    </a>
